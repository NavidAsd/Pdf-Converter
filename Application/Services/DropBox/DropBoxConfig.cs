...
namespace Application.Services.DropBox
{
    public class DropBoxConfig
    {
        ...
        private const string RedirectUri = "https://localhost5001"; // Same as we have configured Under [Application] -> settings -> redirect URIs.  
        #endregion
        ...
        public DropBoxConfig()
        {
            try
            {
                AppKey = GetAncillaryServicesData.GetDropBoxApiKey();
                AppSecret = GetAncillaryServicesData.GetDropBoxSecretKey();
                AppName = "PdfConverter";
            }
            catch (Exception)
            {
