...
namespace Common
{
	...
	public static class GetPath
	{
		...
		public static string GetHomeBanner1()
		{
			LoadJson();
			foreach (var item in Array)
			{
				Result = item.HomeBanner1;
			}
			return Result;
		}
		public static string GetHomeBanner2()
		{
			LoadJson();
			foreach (var item in Array)
			{
				Result = item.HomeBanner2;
			}
			return Result;
		}
		public static string GetHomeBanner3()
		{
			LoadJson();
			foreach (var item in Array)
			{
				Result = item.HomeBanner3;
			}
			return Result;
		}
		public static string GetHomeBanner4()
		{
			LoadJson();
			foreach (var item in Array)
			{
				Result = item.HomeBanner4;
			}
			return Result;
		}
	...
	class Item
	{
		...
		private string HomeBanner1 { set; get; }
		private string HomeBanner2 { set; get; }
		private string HomeBanner3 { set; get; }
		private string HomeBanner4 { set; get; }
